...
const validarCampo = (expresion, input, campo) => {
	if(expresion.test(input.value)){
		...
		document.querySelector(`#grupo__${campo} i`).classList.add('fa-regular fa-circle-xmark');
		document.querySelector(`#grupo__${campo} i`).classList.remove('fa-regular fa-circle-xmark');
...
const validarPassword2 = () => {
	...
	if(inputPassword1.value !== inputPassword2.value){
		...
		document.querySelector(`#grupo__password2 i`).classList.add('fa-regular fa-circle-xmark');
		document.querySelector(`#grupo__password2 i`).classList.remove('fa-regular fa-circle-xmark');
